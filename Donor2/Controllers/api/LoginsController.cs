...
namespace Donor2.Controllers
{
    public class LoginsController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/Logins/LastName/{query}")]
        public ObjectResult<LoginLastNameSearch_Result> LastNameSearch(string query)
        {
            return db.LoginLastNameSearch(query);
        }
        ...
        {
            string newID = id.ToString();
            return db.Logins.Count(e => e.Login_ID == newID) > 0;
        }
    }
}